...
public class InstanceVsClassVariables {
  ...
  public static void test2() {
    System.out.println(message);
    // System.out.println(message2); //! cannot compile cannot access variables
    // which are not static
  }
  // ? An instance variable declared within the class can only be accessed inside
  // NON STATIC methods of the class and
